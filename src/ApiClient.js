...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.IntimaaiApi.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://app.intima.ai/api
     */
    this.basePath = 'https://app.intima.ai/api'.replace(/\/+$/, '');
    ...
    this.authentications = {
      'api_token': {type: 'apiKey', 'in': 'query', name: 'api_token'}
    };
    /**
