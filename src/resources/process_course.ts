...
export class ProcessCourse extends Resource {
    ...
    public async getNewCourse(course: Course): Promise<any> {
        return await this.getAPI().post(`${this.getResourceEndpoint()}`, course);
    }
    ...
    public async captureCourse(course_id: number): Promise<any> {
        return await this.getAPI().get(`${this.action.getResourceEndpoint()}/${this.getResourceEndpoint()}/${course_id}/capture`);
    }
    ...
    public async getNewCourseAndCapture(course: Course): Promise<any> {
        return await this.getAPI().post(`${this.action.getResourceEndpoint()}/${this.getResourceEndpoint()}/create-and-capture`, course);
    }
    ...
    public async deleteCourse(course_id: number): Promise<any> {
        return await this.getAPI().delete(`${this.getResourceEndpoint()}/${course_id}`);
    }
}