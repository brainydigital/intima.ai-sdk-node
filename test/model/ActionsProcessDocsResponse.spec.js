...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntimaaiApi.ActionsProcessDocsResponse();
  });
  ...
  describe('ActionsProcessDocsResponse', function() {
    it('should create an instance of ActionsProcessDocsResponse', function() {
      // uncomment below and update the code to test ActionsProcessDocsResponse
      //var instance = new IntimaaiApi.ActionsProcessDocsResponse();
      //expect(instance).to.be.a(IntimaaiApi.ActionsProcessDocsResponse);
    });
