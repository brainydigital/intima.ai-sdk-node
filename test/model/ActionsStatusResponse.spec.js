...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntimaaiApi.ActionsStatusResponse();
  });
  ...
  describe('ActionsStatusResponse', function() {
    it('should create an instance of ActionsStatusResponse', function() {
      // uncomment below and update the code to test ActionsStatusResponse
      //var instance = new IntimaaiApi.ActionsStatusResponse();
      //expect(instance).to.be.a(IntimaaiApi.ActionsStatusResponse);
    });
